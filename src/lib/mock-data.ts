...
export interface Repo {
  ...
  updated: string;
  private: boolean;
  framework: "Next.js" | "React Vite" | "Vite" | "React" | "Express" | "Python" | "Ruby" | "Go" | "Java" | "PHP" | "Rust" | "unknown";
}
...
export interface FixPreview {
  ...
  ai_output_file?: string; // the single file Claude writes at job time (other files_added are templates)
}
    ...
    diffs: [
      {
        ...
        lines: [
          ...
          add(`EXPOSE 80`, 11),
          add(`HEALTHCHECK --interval=30s --timeout=3s CMD wget -qO- http://localhost/ || exit 1`, 12),
      ...
      },
      {
        ...
        lines: [
          ...
          add(``, 10),
          add(`  gzip on;`, 11),
          add(`  gzip_types text/plain text/css application/javascript application/json image/svg+xml;`, 12),
          add(``, 13),
    ...
    diffs: [
      {
        ...
        lines: [
          hunk("@@ -0,0 +1,6 @@"),
          add(`// AI-generated by Claude — content depends on your actual repo`, 1),
