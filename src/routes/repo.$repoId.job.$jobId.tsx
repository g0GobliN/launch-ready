    ...
    <>
      ...
      <div className="flex items-center justify-between gap-3 rounded-xl border border-primary/30 bg-card/90 p-4 backdrop-blur">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 rounded-md bg-primary px-5 py-2 text-sm font-medium text-primary-foreground transition hover:opacity-90 disabled:opacity-50 cursor-pointer disabled:cursor-not-allowed"
        >
          {confirming ? (
